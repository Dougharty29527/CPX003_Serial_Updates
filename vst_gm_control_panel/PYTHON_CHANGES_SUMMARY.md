...
| Rev 10.7 | 2/9/2026 | Pressure sensor calibration via `send_calibration_command()`. New `"type":"cmd"` message type. ESP32 collects 60 samples, trimmed mean, saves to EEPROM. Web portal Maintenance button and Diagnostics ADC Zero display. |
