...
class DataHandler:
    ...
    def get_current_mode(self):
        ...
        SERIAL-ONLY: Complete mode map matching ESP32 setRelaysForMode() numbers.
        Includes bleed (8) and leak (9) which are used by maintenance screen
        operations (bleed test, leak test). Without these mappings, those modes
        would default to 0 (rest) and ESP32 would set wrong relay states.
        '''
        # SERIAL-ONLY: Complete mode map matching ESP32 setRelaysForMode() numbers
        MODE_MAP = {
